...
const { getAllUser, getUserById, getUserData, userFollowers, getFollowings, getFollowers } = require('./User/user');
...
const userControllers = {
    ...
    getAllUser, getUserById, getUserData, userFollowers, getFollowings, getFollowers
}
